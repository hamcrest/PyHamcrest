...
class IsSequenceContainingInOrderTestBase(object):
    ...
    def testMatchingSingleItemSequence(self):
        self.assert_matches("Single item sequence", contains_exactly(equal_to(1)), self._sequence(1))
    ...
    def testDoesNotMatchIfOneOfMultipleItemsMismatch(self):
        self.assert_mismatch_description("item 2: was <4>",
                            contains_exactly(1,2,3), self._sequence(1,2,4))
    ...
    def testDescribeMismatch(self):
        self.assert_describe_mismatch('item 1: was <3>', contains_exactly(1,2), self._sequence(1,3))
